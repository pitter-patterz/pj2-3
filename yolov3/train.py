...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default=r'D:\computer_vision\yolov3-master\weight\best_84.0.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='', help='model.yaml path')
    parser.add_argument('--data', type=str, default=r'D:\computer_vision\yolov3-master\data\voc.yaml', help='dataset.yaml path')
